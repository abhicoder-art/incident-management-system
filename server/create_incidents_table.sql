...
values
  ('Server Down', 'Main production server is not responding', 'Open', 'High', 'John Doe', null),
  ('Database Slow', 'Database queries are taking longer than usual', 'In Progress', 'Medium', 'Jane Smith', 'Increased connection pool size'),
  ('UI Bug', 'Login button not working on mobile devices', 'Closed', 'Low', 'Mike Johnson', 'Fixed CSS media query issue'); 